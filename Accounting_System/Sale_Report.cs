...
namespace Accounting_System
{
    public partial class Sale_Report : Form
    {
        ...
        private void Sale_Report_Load(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select  * from  MNG_SALE_PANEl", con);
            ...
            try
            {
                
                {
                   // con.Open();
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT * FROM MNG_SALE_PANEL WHERE INVOICE_DATE BETWEEN @StartDate AND @EndDate", con);
